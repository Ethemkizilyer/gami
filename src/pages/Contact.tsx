    ...
    <div className="relative flex items-top justify-center bg-white dark:bg-gray-900 sm:items-center sm:pt-0">
      <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div className="mt-8 overflow-hidden">
          {loading ? (
            <h1 className="h-[440px] font-bold text-[32px] mx-auto">
              Loading...
            </h1>
          ) : (
            <div className="grid grid-cols-1 md:grid-cols-2">
              ...
              >
                ...
                <p className="text-[#94A3B8] text-[20px] font-[400]">
                  ...
                  Maxime voluptatibus consequatur inventore minus?
                </p>
                ...
                <button
                  type="submit"
                  className="md:w-44 bg-[#1E293B] hover:bg-blue-dark mx-auto text-white font-bold py-3 px-6 rounded-lg mt-3 hover:bg-[#334155] transition ease-in-out duration-300"
                >
                  Send Message
                </button>
              </form>
