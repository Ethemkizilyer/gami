    ...
    <section className="w-full mx-auto container">
      <div className="container">
        ...
        <div className="flex flex-wrap -mx-4">
          <div
            onClick={handleClick}
            className="relative h-64 w-64 mx-auto bg-white rounded-lg shadow-lg backface-visibility   "
            style={{
          ...
          >
            <div
              className="h-full w-full absolute top-0 left-0 bg-red-500 
                backface-hidden
            ...
            <div
              className="h-full w-full absolute bg-blue-600 top-0 left-0 backface-hidden
               transition duration-1000 ease-in-out transform"
              style={{
